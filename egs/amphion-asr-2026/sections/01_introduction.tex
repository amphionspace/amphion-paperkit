...
\begin{itemize}
  ...
  \item \textbf{Strong oracle-prompt hotword conditioning.} With
        ...
        CER drops from $5.93$\,\% to $2.82$\,\% on Mandarin and
        the WER from $7.79$\,\% to $5.01$\,\% on English (oracle
  ...
  \item \textbf{A parameter-free hotword retrieval operator.} We
        ...
        to $10^4$. The retriever attains Recall@$K$ above $95\%$
        on Mandarin from $K=10$ onwards and Recall@$K \approx 80\%$
        on English at $K=20$
  ...
  \item \textbf{A noise-robustness SFT stage.} The TS-ASR branch
        ...
        to the plain-ASR branch and is evaluated on
        Voices-in-the-Wild-Bench~\cite{xie2026mega} against eight
        publicly reported systems including Mega-ASR,
