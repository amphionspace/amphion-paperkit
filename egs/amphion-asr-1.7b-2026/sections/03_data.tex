...
plain transcription data included to reduce the risk of catastrophic
forgetting.
...
\begin{enumerate}
  ...
  \item \textbf{Hard negatives.} An online retriever fetches up to
        ...
        orthographically similar distractors train the model to
        distinguish among look-alike hotwords rather than blindly
  ...
  \item \textbf{Random distractors.} The remaining slots are filled
        ...
        irrelevant hotwords and control the prompt list length, so
        the decoder learns to ignore non-matching candidates.
\end{enumerate}
