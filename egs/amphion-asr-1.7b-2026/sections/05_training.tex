...
two general-transcription corpora replayed to mitigate catastrophic
...
examples to reduce the risk of forgetting general transcription while
...
Optimisation (GRPO) to the LLM while keeping the audio
encoder frozen.
...
GRPO uses a subset of the hotword-conditioned and general-transcription
