...
release; the four candidate hypotheses listed in
Section~\ref{sec:tsasr} will be tested in turn before the next training
iteration.

\subsection{Inherited Failure Modes}

LLM-based ASR is known to inherit characteristic LLM failure modes
\citep{radford2023whisper, chu2023qwenaudio}. We have observed (and the
next release will measure):

\begin{itemize}
  \item Repetition loops on long silences or stationary noise
        (especially without explicit noise training, see
